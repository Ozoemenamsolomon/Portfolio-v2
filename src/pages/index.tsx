        ...
        <main className="main-en">
          <section className="home" id="home">
            <div className="hello">
              ...
              <Link state={{ from: "home_hero" }} to="/work">
                View my portfolio
              </Link>
            ...
            <div className="about-content">
              <div className="about-text">
                <p>
                  ...
                  freiberuflichen Hintergrund in Grafikdesign und studiere
                  derzeit Informatik an der Universität Siegen.
                  <br />
                  ...
                  Softwareentwicklung und bin sehr offen für das Erlernen
                  weiterer Technologien mit dem ultimativen Ziel, ein
                  Full-Stack-Entwickler zu werden.
                  <br />
            ...
            <div className="work-content">
              <div className="work-text">
                <p>
                  ...
                  <br />
                  Um mehr über mein Entwiklungsprozess am Beispiel meiner
                  Website zu erfahren, klicken Sie bitte auf die Schaltfläche
                  unten.
                </p>
          ...
          <section className="process" id="process_de">
            ...
            <div className="process-content">
              <div className="process-text">
                <p>
                  Der Plan, meinen Prozess zu dokumentieren, wurde zunächst
                  nicht berücksichtigt. Ich war jedoch inspiriert, diesen
                  Prozess in dieses Projekt einzubeziehen, und zwar durch die
                  Social-Media-Challenge "How it started vs. How it's going".
                  Die folgenden Bilder sollen Ihnen also einen Einblick geben,
                  wie das Projekt begann, und die Tatsache, dass Sie dies hier
                  lesen, ist ein Ergebnis dessen, wie es läuft. "Wie es läuft",
                  weil ich glaube, dass es noch eine Menge Raum für
                  Verbesserungen gibt.
                </p>
              </div>
