      ...
      <main className="main-en">
        <section className="home" id="home">
          <div className="hello">
            ...
            <a href="#work">View my portfolio</a>
        ...
        <section className="about" id="about">
          ...
          <div className="about-content">
            <div className="about-text">
              <p>
                I´m a 22-year-old frontend developer with a freelance background
                in Graphics Design, currently studying computer science in the
                ...
                <br />
                Feel free to reach out to me by using the contact form below or
                by clicking
        ...
        <section className="process" id="process">
          ...
          <div className="process-content">
            <div className="process-text">
              <p>
                The plan to document my process was initially not considered. I
                was however inspired to include this process in this project by
                the social media challenge “How it started vs How it´s going”.
                So the pictures below should give you an insight of how the
                project all started and the fact that you´re reading this here
                is a result of how it´s going. “How it´s going” because I
                believe there is still a lot of room for improvement.
              </p>
            </div>
